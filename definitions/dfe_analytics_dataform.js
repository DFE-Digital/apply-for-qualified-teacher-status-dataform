        ...
        },
        {
            ...
            keys: [{
                ...
                },
                {
                    keyName: "awarded_at",
                    dataType: "timestamp",
                    description: "when the recommendation to award has been applied",
                },
                {
                ...
                },
                {
                    keyName: "declined_at",
                    dataType: "timestamp",
                    description: "when the recommendation to decline has been applied",
                },
                {
                    keyName: "dqt_match",
                    dataType: "string",
        ...
        },
        {
            ...
            keys: [{
                ...
                },
                {
                    ...
                    dataType: "timestamp",
                    description: "when a decision is made to award or decline. Awarded_at and declined_at represent when the award/decline actually happened",
                },
                {
                ...
                },
                {
                    keyName: "started_at",
                    dataType: "timestamp",
                    description: "set when an assessor assesses any part of the application, so for applications which require a preliminary check, that includes the preliminary check",
                },
                {
                    keyName: "subjects",
                    dataType: "string",
